...
const Timer = ()=>{
  ...
  return `${hours}:${minutes}:${seconds}`;
    ...
    return (
        <div style={{width:"62vw",height:"35vh",background:"#1E2343", borderRadius:"12px",marginTop:"10px",display:"flex", gap:"20px",boxSizing:"border-box",padding:"12px", alignItems:"center", justifyContent:"space-evenly"}}>
            <div>
            ...
            <div style={{width:"35vw", textAlign:"center"}}>
                <div style={{color:"white",display:"flex", fontSize:"2rem", justifyContent:"space-evenly"}}>
                    <div style={{textAlign:"center", padding:"2px"}}>
                        <p style={{margin:"0",padding:"none"}}>Hours</p>
                    ...
                    <div style={{textAlign:"center", padding:"2px"}}>
                        <p style={{margin:"0",padding:"none"}}>Minutes</p>
                   ...
                   <div style={{textAlign:"center", padding:"2px"}}>
                        <p style={{margin:"0",padding:"none"}}>Seconds</p>
                ...
                <div onClick={()=>setPlaying((prev)=>!prev)}  style={{background:"#FF6A6A", borderRadius:"12px", padding:"10px", color:"white", textAlign:"center",}}>
                    {playing?<p style={{margin:"0",padding:"none"}}>Pause</p>:<p style={{margin:"0",padding:"none"}}>Start</p>}
                </div>
            </div>
        </div>
    )
